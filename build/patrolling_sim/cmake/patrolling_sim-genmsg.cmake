...
set(MSG_I_FLAGS "-Ipatrolling_sim:/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/PosRot.msg" NAME_WE)
add_custom_target(_patrolling_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "patrolling_sim" "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/PosRot.msg" ""
)

get_filename_component(_filename "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/UnityColor.msg" NAME_WE)
add_custom_target(_patrolling_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "patrolling_sim" "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/UnityColor.msg" ""
)

get_filename_component(_filename "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/XCordenate.msg" NAME_WE)
add_custom_target(_patrolling_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "patrolling_sim" "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/msg/XCordenate.msg" ""
)

get_filename_component(_filename "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/srv/GoToStartPosSrv.srv" NAME_WE)
add_custom_target(_patrolling_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "patrolling_sim" "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/srv/GoToStartPosSrv.srv" "std_msgs/UInt8"
)
...
_generate_srv_cpp(patrolling_sim
  "/home/jorgeurjc/Documentos/AgroRobotSimulator/src/patrolling_sim/srv/GoToStartPosSrv.srv"
  "${MSG_I_FLAGS}"
